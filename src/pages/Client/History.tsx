                ...
                <div className="bg-amber-500/20 text-amber-500 text-sm font-bold p-4 -mx-5 -mt-5 mb-5 border-b border-amber-500/20 flex flex-col gap-3">
                  ...
                  <div className="bg-black/40 rounded-xl p-4 border border-amber-500/20 space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                       <span className="font-mono bg-white/10 px-3 py-2 rounded-lg text-white font-medium border border-white/20 select-all">122.836.777-76</span>
                       <button
                         onClick={() => {
                           navigator.clipboard.writeText("12283677776");
                           alert("Chave PIX copiada!");
                         }}
                         className="px-3 py-2 bg-amber-500 text-amber-950 rounded-lg hover:bg-amber-600 transition-colors uppercase text-[10px] font-black"
                       >
                         Copiar Chave
                       </button>
                    </div>
                    
                    <p className="text-white/60 text-xs font-normal">Envie o comprovante pelo WhatsApp:</p>
                    <a 
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#1ebd5a] transition-all active:scale-95 leading-none"
                    >
                      ...
                      <span className="font-bold text-xs uppercase">Enviar Comprovante</span>
                    </a>
                  </div>
                </div>
              )}
