          ...
          appointments.map((apt) => (
            <div key={apt.id} className={cn(
              ...
              {apt.status === 'confirmed' && (
                <div className="bg-amber-500/20 text-amber-500 text-sm font-bold p-3 -mx-5 -mt-5 mb-5 border-b border-amber-500/20 flex items-center gap-2">
                  <AlertCircle className="w-4 h-4" />
                  Agendamento Aprovado! Chegue com 10 minutos de antecedência para iniciar o corte.
                </div>
              )}
